...
class Single_Thread_Stats_Unit_Test(unittest.TestCase):
  ...
  def df_std_index(self):
      ...
      '''
      self.assertEqual(df_stats_index.std(0)[0], np.std(np_data))
